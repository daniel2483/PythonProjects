...
class dialogBox(wx.Dialog):
    def __init__(self, parent, title):
        ...
        email_list = ['alerosan1@gmail.com', 'gladysrosan@gmail.com', 'jdrs2483@gmail.com', 'jdrs2483@yahoo.com']
...
class MyFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        ids = ['Alejandro Rodríguez Sánchez | 2-0626-0889 | 066-530',
               'Gladys Rodríguez Sánchez | 1-1082-0034 | 066-189',
               'Fabio Rodríguez González | 6-0106-1307 | 066-076',
        ...
        text.SetFont(fontCredits)
        # text.SetBackgroundColour(wx.Colour(255, 255, 255))
        text = wx.StaticText(panel, label="Last Update: 2020-08-21", pos=(pos_ini_x - 90, pos_ini_y + 540))
        text.SetFont(fontCredits)
        # text.SetBackgroundColour(wx.Colour(255, 255, 255))
        ...
        self.reason.Bind(wx.EVT_TEXT, self.checkingFields)
